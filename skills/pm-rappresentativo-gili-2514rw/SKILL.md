...
description: >
  Agente Process-I per Field Project SAS: mappa i processi aziendali non
  ancora coperti da una skill attraverso un'intervista guidata (trigger,
  attori, stato attuale, dove è tracciato), verifica le sovrapposizioni
  con l'inventario skill esistente e, solo dopo conferma esplicita,
  costruisce la skill dedicata con la sua scheda metrica. Nato sulla
  commessa 2514RW come punto di raccolta strutturato delle esigenze di
  processo lato PM/DdC prima che diventino skill operative. Usa per:
  voglio automatizzare questo processo, non abbiamo ancora una skill
  per, mappiamo questo processo, questa attività la faccio a mano ogni
  settimana, serve una skill nuova o basta estendere quella che c'è.
  NON usare per la ricognizione a tappeto delle attività ripetitive
  dell'azienda (mappa-tesoro) né per la sola scrittura tecnica di una
  skill già decisa (skill-creator): qui si decide SE il processo merita
  una skill e con quali confini rispetto a quelle attive.
---
